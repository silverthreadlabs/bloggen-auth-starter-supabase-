...
export async function generateMetadata({ params }: { params: Promise<{ slug?: string[] }> }) {
    ...
    if (!resolvedParams.slug || resolvedParams.slug.length === 0) {
        return createPageMetadata({
            path: currentPath,
            description:
                'Learn how to build, customize, and grow your site with Bloggen Auth Starter Supabase and Bloggen AI. Setup guides, tips, and SEO content strategies—all in one place.',
